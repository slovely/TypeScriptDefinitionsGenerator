...
//        }
//
        private static List<TypeScriptDefinitionsGenerator.Common.ActionParameterInfo> GetActionParameters(MethodInfo action)
        {
            var result = new List<TypeScriptDefinitionsGenerator.Common.ActionParameterInfo>();
            var parameters = action.GetParameters();
            foreach (var parameterInfo in parameters)
            {
                var param = new TypeScriptDefinitionsGenerator.Common.ActionParameterInfo();
