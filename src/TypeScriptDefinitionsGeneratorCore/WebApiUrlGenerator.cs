...
namespace TypeScriptDefinitionsGenerator
{
    public class WebApiUrlGenerator
    {
        public string GetUrl(MethodInfo method)
        {
            ...
            var routeAttr = method.GetCustomAttributes().FirstOrDefault(a => a.GetType().FullName == "Microsoft.AspNetCore.Mvc.RouteAttribute");
            if (routeAttr != null)
            {
        ...
        private static string GetActionName(MethodInfo method)
        {
            var actionNameAttribute = method.GetCustomAttributes(false)
                .FirstOrDefault(a => a.GetType().FullName == "Microsoft.AspNetCore.Mvc.ActionNameAttribute");
